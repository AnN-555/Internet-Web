document.addEventListener("DOMContentLoaded", function () {
    ...
    const dates = localStorage.getItem("stay_dates") || "26 Sep 2025 - 27 Sep 2025 (1 Night)";
    ...
    if (infoDivs[0]) {
        infoDivs[0].innerHTML =
            `<img src="../../images/reservation/reservation-page-5/information.png" style="height:20px"> 
        ${title ? title.toUpperCase() : ""} ${firstName} ${lastName}`;
    }

    if (infoDivs[1]) {
        infoDivs[1].innerHTML =
            `<img src="../../images/reservation/reservation-page-5/telephone.png" style="height:20px"> 
        ${phone}`;
    }

    if (infoDivs[2]) {
        infoDivs[2].innerHTML =
            `<img src="../../images/reservation/reservation-page-5/email.png" style="height:20px"> 
        ${email}`;
    }
    ...
    continueBtn.addEventListener("click", function (e) {
        ...
        const cvv = document.querySelector('.input-with-icons:last-of-type input[type="text"]');
